  ...
  <body>
    ...
    <div class="container">
      <div class="alert alert-light d-flex justify-content-center" role="alert">
          กระทู้ทั้งหมดของ <a href="#" class="alert-link"><?php echo $user?></a>
      </div>
    ...
    <table class="table table-hover">
      ...
      $rows = 6;
      $sql = "select * from question where q_user = '$user'";
      ...
      $selection = "select * from question where q_user = '$user' ORDER BY q_no DESC Limit $strat,6";
      ...
      <div class="d-flex justify-content-center">
        <nav aria-label="Page navigation example">
          <ul class="pagination">
            ...
            ?>
            <li class="page-item">
              <a class="page-link" href="form_board_user.php?page=<?php echo ($page-1)?>&&user=<?php echo $user?>" aria-label="Previous">
            ...
            ?>>
              <a class="page-link" href="form_board_user.php?page=<?php echo $i?>&&user=<?php echo $user?>" ><?php echo $i?></a></li>
            <?php
              }
            ...
            <li class="page-item">
              <a class="page-link" href="form_board_user.php?page=<?php echo ($page+1)?>&&user=<?php echo $user?>" aria-label="Next">
