  ...
  <body>
    <?php
      session_start();
        $page = $_GET['page'];
    ?>
<form action="insert_board.php" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
  <div class="container">
    <div class="card">
      <div class="card-header">
        <center>ฟอร์มตั้งกระทู้</center>
      </div>
      <div class="card-body">
        <div class="form-group">
          <label for="exampleFormControlInput1">หัวข้อกระทู้</label>
          <input type="text" name="topic" class="form-control" id="exampleFormControlInput1" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <center><button type="submit" class="btn btn-success">ส่งกระทู้</button> <a href="form_board.php?page=<?php echo $page?>"><button type="button" name="button" class="btn btn-danger">ยกเลิก</button></a></center>
        </div>
      </div>
    </div>
  </div>
