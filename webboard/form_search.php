  ...
  <body>
    ...
    <div class="container">
      <div class="alert alert-light d-flex justify-content-center" role="alert">
          กระทู้ทั้งหมดจาก <?php echo $search?>
      </div>
    ...
    <table class="table table-hover">
      ...
      $rows = 6;
      $sql = "select * from question where q_topic LIKE '%$search%'";
      ...
      $selection = "select * from question where q_topic LIKE '%$search%' ORDER BY q_no DESC Limit $strat,6";
      ...
      <div class="d-flex justify-content-center">
        <nav aria-label="Page navigation example">
          <ul class="pagination">
            ...
            ?>
            <li class="page-item">
              <a class="page-link" href="form_search.php?page=<?php echo ($page-1)?>&&search=<?php echo $search?>" aria-label="Previous">
            ...
            ?>>
              <a class="page-link" href="form_search.php?page=<?php echo $i?>&&search=<?php echo $search?>"><?php echo $i?></a></li>
            <?php
              }
            ...
            <li class="page-item">
              <a class="page-link" href="form_search.php?page=<?php echo ($page+1)?>&&search=<?php echo $search?>" aria-label="Next">
