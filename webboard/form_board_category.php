  ...
  <body>
    ...
    <div class="container">
      <div class="alert alert-light d-flex justify-content-center" role="alert">
          กระทู้ทั้งหมดของประเภท <a href="#" class="alert-link"><?php echo $category?></a>
      </div>
    ...
    <table class="table table-hover">
      ...
      $rows = 6;
      $sql = "select * from question where q_category = '$category'";
      ...
      $selection = "select * from question where q_category = '$category' ORDER BY q_no DESC Limit $strat,6";
      ...
      <div class="d-flex justify-content-center">
        <nav aria-label="Page navigation example">
          <ul class="pagination">
            ...
            ?>
            <li class="page-item">
              <a class="page-link" href="form_board_category.php?page=<?php echo ($page-1)?>&&category=<?php echo $category?>" aria-label="Previous">
            ...
            ?>>
              <a class="page-link" href="form_board_category.php?page=<?php echo $i?>&&category=<?php echo $category?>" ><?php echo $i?></a></li>
            <?php
              }
            ...
            <li class="page-item">
              <a class="page-link" href="form_board_category.php?page=<?php echo ($page+1)?>&&category=<?php echo $category?>" aria-label="Next">
