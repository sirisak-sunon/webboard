  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          <li class="nav-item">
            <a class="nav-link" href="form_add_board.php?page=<?php echo $page?>">ตั้งกระทู้ <span class="sr-only"></span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="form_board.php?page=1">กระทู้ทั้งหมด <span class="sr-only">(current)</span></a>
          </li>
    ...
    <div class="container">
      <div class="alert alert-light d-flex justify-content-center" role="alert">
          กระทู้ทั้งหมดที่มียอดเข้าชมตั้งแต่ 100 ขึ้นไป
      </div>
    ...
    <table class="table table-hover">
      ...
      $rows = 6;
      $sql = "select * from question where q_view >= 100";
      ...
      $selection = "select * from question where q_view >= 100 ORDER BY q_no DESC Limit $strat,6";
      ...
      <div class="d-flex justify-content-center">
        <nav aria-label="Page navigation example">
          <ul class="pagination">
            ...
            ?>
            <li class="page-item">
              <a class="page-link" href="form_board_Popular.php?page=<?php echo ($page-1)?>" aria-label="Previous">
            ...
            ?>>
              <a class="page-link" href="form_board_Popular.php?page=<?php echo $i?>" ><?php echo $i?></a></li>
            <?php
              }
            ...
            <li class="page-item">
              <a class="page-link" href="form_board_Popular.php?page=<?php echo ($page+1)?>" aria-label="Next">
